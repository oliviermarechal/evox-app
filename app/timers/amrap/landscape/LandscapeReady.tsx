...
export default function LandscapeReady({ config, onStartCountdown, onBack, onSkipCountdown, countdownValue, isCountdown, isPaused, onTogglePause }: LandscapeReadyProps) {
  // Animation values
